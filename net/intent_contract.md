# Network Intent Contract (Client Presentation)
...
the client-side presentation shell.
...
While server compatibility remains blocked in [docs/SERVER-COMPATIBILITY.md](../docs/SERVER-COMPATIBILITY.md),
