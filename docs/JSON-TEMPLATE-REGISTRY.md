...
The future client may consume published snapshots from [ultod-json-template-registry](https://github.com/zedarvates/ultod-json-template-registry), but the registry is not a live game database or an authoritative server configuration.
...
- Vendor an reviewed snapshot for deterministic builds.
- Never download or activate templates automatically at runtime.
