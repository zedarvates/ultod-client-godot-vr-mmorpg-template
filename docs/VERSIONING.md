...
A version number never proves compatibility. Every supported combination must be listed with its Godot version, server protocol version, operating system and tested runtime. An absent combination is unsupported.
